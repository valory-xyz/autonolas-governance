## Comparison of the actual maple token code against the audited v1 release
```
diff --git a/contracts/ERC20.sol b/contracts/ERC20.sol
index 78cd35e..3582816 100644
--- a/contracts/ERC20.sol
+++ b/contracts/ERC20.sol
@@ -3,12 +3,25 @@ pragma solidity ^0.8.7;
...
@@ -20,10 +33,19 @@ contract ERC20 is IERC20 {
...
+     *  @param decimals_ The decimal precision used by the token.
     ...
     constructor(string memory name_, string memory symbol_, uint8 decimals_) {
         name     = name_;
@@ -40,17 +62,72 @@ contract ERC20 is IERC20 {
         return true;
     }
...
+
     ...
     /*** Internal Functions ***/
     /**************************/
@@ -59,25 +136,39 @@ contract ERC20 is IERC20 {
