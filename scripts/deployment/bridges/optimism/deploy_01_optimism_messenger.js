...
async function main() {
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/bridges/optimism/verify_01_optimism_messenger.js --network " + providerName + " " + optimismMessenger.address, { encoding: "utf-8" });
    }
}
