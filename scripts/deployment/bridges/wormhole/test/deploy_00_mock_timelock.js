...
async function main() {
    ...
    console.log("You are signing the following transaction: Timelock.connect(EOA).deploy(L1WormholeRelayerAddress)");
    const timelock = await Timelock.connect(EOA).deploy(parsedData.L1WormholeRelayerAddress);
